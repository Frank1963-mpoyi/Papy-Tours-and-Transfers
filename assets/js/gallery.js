...
const translations = {
    en: {
        ...
        chat_welcome: "Hi there! 👋 Welcome to Cape Town Adventures. How can we help you today?",
    ...
    fr: {
        ...
        booking: "Réservation",
        contact: "Contact",
        hero_title: "Découvrez Le Cap comme jamais auparavant",
        hero_subtitle: "Explorez la ville mère avec des guides locaux passionnés et créez des souvenirs inoubliables",
        explore_tours: "Découvrir les circuits",
        book_now: "Réserver maintenant",
        about_title: "À propos de Cape Town Adventures",
        about_subtitle: "Vos experts locaux en tourisme au Cap",
        our_story: "Notre histoire",
        story_text: "Fondée en 2015 par des passionnés locaux, Cape Town Adventures est née du désir de partager la beauté et la diversité de notre ville incroyable avec le monde. Nous croyons en un tourisme durable qui profite à la fois aux visiteurs et aux communautés locales.",
        story_text2: "Avec plus de 8 ans d'expérience, notre équipe de guides certifiés connaît chaque recoin du Cap - de l'emblématique Table Mountain aux joyaux cachés que seuls les locaux connaissent. Nous nous engageons à créer des expériences personnalisées qui vont au-delà des sentiers touristiques habituels.",
        why_choose: "Pourquoi nous choisir",
        local_expertise: "Expertise locale:",
        expertise_text: "Nés et élevés au Cap avec une connaissance approfondie de la région",
        personalized: "Expériences personnalisées:",
        personalized_text: "Circuits sur mesure adaptés à vos intérêts",
        sustainable: "Tourisme durable:",
        sustainable_text: "Soutien aux communautés locales et à la conservation",
        service: "Service 5 étoiles:",
        service_text: "Dédié à rendre votre expérience inoubliable",
        testimonials_title: "Ce que disent nos voyageurs",
        testimonials_subtitle: "Expériences réelles de nos clients satisfaits",
        testimonial1: "\"Notre visite de Table Mountain a été le point fort de notre voyage en Afrique du Sud. La connaissance de la flore et de l'histoire locales par le guide a rendu l'expérience vraiment spéciale. Nous nous sommes sentis complètement en sécurité et pris en charge tout au long de la journée.\"",
        testimonial2: "\"La visite de la péninsule du Cap a dépassé toutes nos attentes ! David était un guide exceptionnel qui a adapté la journée à nos intérêts. Les paysages étaient à couper le souffle, et nous avons beaucoup appris sur l'histoire et la culture de l'Afrique du Sud.\"",
        testimonial3: "\"La visite des régions viticoles était absolument parfaite. Nous avons visité trois magnifiques vignobles et avons apprécié des accords mets-vins gastronomiques. La connaissance des vins par le guide a rendu l'expérience à la fois éducative et amusante !\"",
        ...
        peninsula_tour: "Visite de la Péninsule du Cap",
        winelands_tour: "Visite des Régions Viticoles"
    },
    pt: {
        ...
        hero_subtitle: "Descubra a Cidade Mãe com guias locais apaixonados e crie memórias inesquecíveis",
        ...
        story_text: "Fundada por locais apaixonados em 2015, a Cape Town Adventures nasceu do desejo de compartilhar a beleza e diversidade de nossa incrível cidade com o mundo. Acreditamos em um turismo sustentável que beneficie tanto os visitantes quanto as comunidades locais.",
        story_text2: "Com mais de 8 anos de experiência, nossa equipe de guias certificados conhece cada canto da Cidade do Cabo - desde a icônica Table Mountain até joias escondidas que só os locais conhecem. Estamos comprometidos em criar experiências personalizadas que vão além do roteiro turístico típico.",
        ...
        sustainable: "Turismo Sustentável:",
        sustainable_text: "Apoiando comunidades locais e conservação",
        service: "Serviço 5 Estrelas:",
        service_text: "Dedicado a tornar sua experiência inesquecível",
        testimonials_title: "O Que Nossos Viajantes Dizem",
        testimonials_subtitle: "Experiências reais de nossos clientes felizes",
        testimonial1: "\"Nosso passeio pela Table Mountain foi o destaque de nossa viagem à África do Sul. O conhecimento do guia sobre a flora e história locais tornou a experiência verdadeiramente especial. Nós nos sentimos completamente seguros e cuidados durante todo o dia.\"",
        testimonial2: "\"O passeio pela Península do Cabo superou todas as expectativas! David foi um guia excepcional que adaptou o dia aos nossos interesses. A paisagem era deslumbrante e aprendemos muito sobre a história e cultura da África do Sul.\"",
        testimonial3: "\"O passeio pelas regiões vinícolas foi absolutamente perfeito. Visitamos três vinícolas lindas e apreciamos harmonizações gastronômicas. O conhecimento do guia sobre vinhos tornou a experiência educativa e divertida!\"",
        from_usa: "Dos EUA",
        from_germany: "Da Alemanha",
        from_australia: "Da Austrália",
        april_2023: "15 de abril de 2023",
        june_2023: "2 de junho de 2023",
        march_2023: "22 de março de 2023",
        table_mountain: "Passeio pela Table Mountain",
        peninsula_tour: "Passeio pela Península do Cabo",
        winelands_tour: "Passeio pelas Regiões Vinícolas"
    }
};
...
document.getElementById('contactForm').addEventListener('submit', function(e) {
    ...
    if (isValid) {
        // Form is valid - in a real scenario, you would submit the form here
        alert(translations[currentLang].thank_you_message);
        this.reset();
    }
});
...
document.getElementById('bookingForm').addEventListener('submit', function(e) {
    ...
    const tourSelectError = document.getElementById('tourSelectError');
    if (!tourSelect.value) {
        tourSelect.classList.add('error-input');
        tourSelectError.style.display = 'block';
        isValid = false;
    } else {
        tourSelect.classList.remove('error-input');
        tourSelectError.style.display = 'none';
    }
    ...
    if (bookingDate.value.trim() === '') {
        bookingDate.classList.add('error-input');
        bookingDateError.style.display = 'block';
        isValid = false;
    } else {
        bookingDate.classList.remove('error-input');
    ...
    if (!participants.value) {
        participants.classList.add('error-input');
        participantsError.style.display = 'block';
        isValid = false;
    } else {
        participants.classList.remove('error-input');
        participantsError.style.display = 'none';
    }
    
    // Name validation
    const bookingName = document.getElementById('bookingName');
    const bookingNameError = document.getElementById('bookingNameError');
    if (bookingName.value.trim() === '') {
        bookingName.classList.add('error-input');
        bookingNameError.style.display = 'block';
        isValid = false;
    } else {
        bookingName.classList.remove('error-input');
        bookingNameError.style.display = 'none';
    }
    ...
    if (!emailRegex.test(bookingEmail.value)) {
        bookingEmail.classList.add('error-input');
        bookingEmailError.style.display = 'block';
        isValid = false;
    } else {
        bookingEmail.classList.remove('error-input');
        bookingEmailError.style.display = 'none';
    }
    
    if (isValid) {
        // Form is valid - in a real scenario, you would submit the form here
        alert(translations[currentLang].thank_you_booking);
        this.reset();
    }
});
